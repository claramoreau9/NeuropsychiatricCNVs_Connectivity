...
% More information about NIAK are available here https://niak.simexp-lab.org/build/html/PREPROCESSING.html
% More information about MIST parcellation https://simexp.github.io/multiscale_dashboard/index.html

clear all

root_path = '/project/DATA/';
path_raw = [root_path 'RAW/'];
...
opt.psom.qsub_options = '--mem=4G  --account rpp-aevans-ab --time=00-10:00  --ntasks=1 --cpus-per-task=1';
